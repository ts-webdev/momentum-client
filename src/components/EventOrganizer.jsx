    ...
    return (
        <div className='my-48 bg-linear-to-b from-[#FFC8DD]/30 to-white'>
            <div className="max-w-7xl mx-auto py-20 px-5">
                ...
                <div className='flex justify-between flex-col lg:flex-row items-center gap-20 mt-10'>
                    {/* left side text*/}
                    <div className='lg:w-1/2 flex items-center flex-col gap-5 text-center'>
                    <Image src="/logo.png" height={100} width={100} alt='Momentum logo'/>
                        <h1 className='md:text-5xl text-4xl w-5/6 font-bold mx-auto'>Meet Our Creative Event Organizer</h1>
