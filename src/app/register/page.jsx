...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[70vh] flex items-center bg-linear-to-b from-primary/20 pt-35 -mt-25 justify-center p-4">
      <div className="w-full max-w-md bg-white/50 shadow-lg rounded-xl mb-10 p-8">
